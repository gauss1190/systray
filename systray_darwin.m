...
@interface AppDelegateSystray: NSObject <NSApplicationDelegate>
...
@implementation AppDelegateSystray {
...
- (void)applicationDidFinishLaunching:(NSNotification *)aNotification {
  ...
  //[self->menu setDelegate:(AppDelegateSystray *)self];
...
void registerSystray(void) {
  ...
  owner = [[AppDelegateSystray alloc] init];
